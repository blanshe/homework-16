...
},{"topojson-client":"../node_modules/topojson/node_modules/topojson-client/index.js","topojson-server":"../node_modules/topojson/node_modules/topojson-server/index.js","topojson-simplify":"../node_modules/topojson/node_modules/topojson-simplify/index.js"}],"data/counties_with_election_data.topojson":[function(require,module,exports) {
module.exports = "/counties_with_election_data.d6d686ea.topojson";
...
var projection = d3.geoAlbersUsa(); // out geoPath needs a PROJECTION variable

var path = d3.geoPath().projection(projection);
d3.json(require('/data/counties_with_election_data.topojson')).then(ready).catch(function (err) {
...
function ready(json) {
  ...
  var opacityScale = d3.scaleLinear().domain([0, 80000]).range([0, 1]).clamp(true); // Not sure how to do scale/center/etc?
  // Just use .fitSize to center your map
  // and set everything up nice

  projection.fitSize([width, height], counties);
  svg.selectAll('.state').data(counties.features).enter().append('path').attr('class', 'state').attr('d', path).attr('stroke', 'none').attr('fill', function (d) {
    if (!d.properties.state) {
      return 'lightgrey';
    } else {
      var percent = d.properties.trump / (d.properties.trump + d.properties.clinton);
      return colorScale(percent);
    }
  }).attr('opacity', function (d) {
    var total = d.properties.trump + d.properties.clinton;
    return opacityScale(total);
  });
}
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","/data/counties_with_election_data.topojson":"data/counties_with_election_data.topojson"}]},{},["scripts/homework-17/04a-map.js"], null)
